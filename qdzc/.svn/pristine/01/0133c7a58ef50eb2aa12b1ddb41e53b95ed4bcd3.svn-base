...
public class CanalProcessDetailAction extends ActionSupport {
	...
	private String getDate() {
		...
		try {
			...
			sql = "SELECT @rownum :=@rownum + 1 AS rownum,t.* FROM (SELECT @rownum := 0) r, ( SELECT a.in_id, a.canal_id, a.canal_name, a.step_val, a.oper_user, a.dept_name, date_format(a.oper_time,'%Y-%m-%d %H:%i:%s') oper_time, a.process_state,a.remark FROM qdzc.process_detail_add a where in_id='"
					+ inId + "' ";
