...
public class ScanImgUploadAction extends ActionSupport{
	...
	// 同上
		...
		String savePath = ServletActionContext.getServletContext().getRealPath(
				""); // 获取项目根路径
		savePath = savePath + "/upload/certificate"; // 拼串组成要上传保存文件的路径，即：D:\Program
	    		extName = this.getMyFileHeadFileName().substring(this.getMyFileHeadFileName().lastIndexOf(".")); 
