       ...
       var inId = 0;
     	$(document).ready(function() {
     		  ...
     		  $("#myFile").uploadify({
                    ...
                    'script' : 'organizationAddExcelAction',//后台处理的请求
	    ...
	    function f_download(){
	      		var url = "organizationExcelFileDownloadAction";
		  		window.open(url);
	    		window.close();
	      }
    ...
    <form name="form1" method="post" action="supplierQuery" id="form1">
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
           <tr >   
                ...
                <td align="right" class="l-table-edit-td" >部门信息添加模板:</td>
