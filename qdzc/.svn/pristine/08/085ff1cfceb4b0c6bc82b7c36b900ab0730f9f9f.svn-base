...
<body style="padding:10px">
    ...
    <form name="form1" method="post" action="" id="form1">
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
          ...
          <!--   
          <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>员工姓名:</td>
                <td align="left" class="l-table-edit-td"> 
                <input  ltype="text"  name="employeeName" id="employeeName" type="text" ltype="text"  />
                </td>
            </tr>
            这里不需要员工字段
           -->
                <tr>
                <td align="right" class="l-table-edit-td">代理商门户网站工号:</td>
                <td align="left" class="l-table-edit-td"> 
                
                 <input  ltype="text"  name="employeeName" id="employeeName" type="hidden" ltype="text" value="无"/>
                <input  ltype="text"  name="agentJobNumber" id="agentJobNumber" <c:if test="${request.crmNumber!='no' }"> value="${request.crmNumber }" readonly="readonly"</c:if>  type="text" />
                <font size="1" color="red">此处的代理商门户网站工号是上一流程中对应的CRM工号前面机上LZ</font></td>
            </tr>
...
<script type="text/javascript">
  function ajaxUpdate(){//提交表单内容
			 ...
			 params = encodeURIComponent(encodeURIComponent(params)).replace(/%253D/g,'=').replace(/%2526/g,'&');
		      ...
		      $.ajax({   //把表单内容插入数据库
		              url :'openAgentWebAddAction',  //后台处理程序   
		              type:'post',    //数据发送方式   
