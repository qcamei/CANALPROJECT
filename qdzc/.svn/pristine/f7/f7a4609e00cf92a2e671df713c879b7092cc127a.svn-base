    ...
    <form name="form1" method="post" action="" id="form1">
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="500px">
        		<tr>
					...
					<td>
						<input	name="canalId"  id="canalId"  type="hidden" value="${param.canalId }" readonly="readonly" />
						<input	name="inId"  id="inId"  type="text" value="${param.inId }" readonly="readonly" />
					</td>
				</tr>
				<tr height="10px"></tr>
				<tr>
					...
					<td>
						<input	name="canalName"    id="canalName"  type="text"   readonly="readonly" />
					</td>		
				</tr>
				<tr height="10px"></tr>
				<tr>
						...
						<td align="left" class="l-table-edit-td">
							<input name="crmNumber" type="text" id="crmNumber" validate="{required:true}" />
						</td>
				</tr>
				<tr height="10px"></tr>
				<tr>
						...
						<td align="left" class="l-table-edit-td">
							<input	name="phone" type="text" id="phone" onchange="check()" validate="{required:true}" />
						</td>						
				</tr>
				<tr height="10px"></tr>
            <tr>
