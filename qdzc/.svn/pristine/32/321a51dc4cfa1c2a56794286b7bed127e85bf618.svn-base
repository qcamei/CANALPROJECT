	 ...
	 function ajaxUpdate(){//提交表单内容
         $.blockUI({message:'<h4><img src="../images/loading.gif" /> 系统正在提交中……</h4>' }); 
	         ...
	         var close='<%= request.getParameter("closeId")%>';  
		      ...
		      $.ajax({   //把表单内容插入数据库
		              url :'writeCanalCloseContentFGBMAction?inId='+ind+'&closeId='+close,  //后台处理程序    //后台处理程序   
		              type:'post',    //数据发送方式   
...
<tr> <td align="right" class="l-table-edit-td"></td></tr>
 <tr>
	...
	<td class="l-table-edit-td"  width="120px" >
		<input type="text" id="auditState" name="auditState"   />
    </td>
 </tr>
 <tr> <td align="right" class="l-table-edit-td"></td></tr>
 <tr>
 ...
 <td align="left" class="l-table-edit-td"> 
	<textarea name="refuseReason"  cols="100" rows="8" class="l-table-edit-td"  ></textarea>
 </td>
</tr>
 <tr>
