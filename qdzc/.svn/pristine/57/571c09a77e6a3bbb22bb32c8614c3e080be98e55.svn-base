...
public class ParentDeptNameQueryAction extends ActionSupport {
	...
	public String getDate() {
		...
		try {
			...
			sql = "select dept_id as id,dept_name as text from sys_dept where dept_level='分公司' and city_id='"+cityId+"'";
			logger.info(sql);
