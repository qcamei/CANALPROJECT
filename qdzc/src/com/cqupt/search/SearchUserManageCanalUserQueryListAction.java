...
public class SearchUserManageCanalUserQueryListAction extends ActionSupport {
	//
	...
	private String getDate() {
		...
		try {
			...
			sql = "SELECT 	@rownum :=@rownum + 1 AS rownum,t.* from (select @rownum:=0) r,(SELECT a.user_name,a.user_id,a.user_sex,a.user_phone,date_format(a.oper_time,'%Y-%m-%d %H:%i:%s') oper_time"
