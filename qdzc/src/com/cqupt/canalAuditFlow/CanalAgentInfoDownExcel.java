...
public class CanalAgentInfoDownExcel extends ActionSupport {
	...
	public String execute() {
		...
		try {
			...
			String[] title = { "序号", "工单号", "当前状态", "下一状态", "是否驳回", "驳回原因",
					...
					"分类名称", "上级渠道", "客户经理", "VPDN", "代理商编码", "归属代理商", "操作部门",
			...
			String[] keys = { "rownum", "inId", "currentStepVal",
					...
					"canalParentName", "canalUserName", "broadbandAccount",
					"agentId", "agentName", "deptName", "operUser", "operTime",
					"remark" };
