			...
			if (resultStr.equals("success")) {
				...
				if (auditState.equals("通过")) {
					sql = "update qdzc.canal_step_state set current_step = "
							+ currentStep + ",branch_audit_time=sysdate(),"
							+ "branch_audit_name='" + currentStepVal
							+ "',branch_audit_state='" + auditState
							+ "',is_back='" + isBack
					...
					// 4.操作入环节“配置稽核人员”
					sql = "insert into qdzc.process2_branch_audit (in_id,canal_id,canal_name,audit_state,oper_user,dept_id,dept_name,oper_time,audit_remark) values ("
							+ "'"
							+ inId
							+ "','"
							+ canalId
