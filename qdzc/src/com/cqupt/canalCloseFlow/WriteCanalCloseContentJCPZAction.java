...
public class WriteCanalCloseContentJCPZAction extends ActionSupport {
	// 分管部门审核函数
		...
		try {
			...
			if (resultStr.equals("success")) {
				...
				if ("通过".equals(auditState)) {
					...
					// 添加流程状态表
					sql = "update  qdzc.canal_step_state_close set oper_user9="
							+ "'" + userName + "',dept_id9='" + deptId
							+ "',dept_name9='" + deptName + "',"
							+ " device_time='" + operTime + "', "
							+ "device_name='" + currentStepVal
							+ "',device_state='" + auditState
