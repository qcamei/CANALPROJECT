...
public class WriteCanalCloseContentZJJHAction extends ActionSupport {
	// 资金稽核审核函数
		...
		try {
			...
			if (resultStr.equals("success")) {
				...
				if ("通过".equals(auditState)) {
					...
					// 添加流程状态表
					sql = "update  qdzc.canal_step_state_close set oper_user7="
							+ "'" + userName + "',dept_id7='" + deptId
							+ "',dept_name7='" + deptName + "',"
							+ " check_code_time='" + operTime + "', "
							+ "check_code_name='" + currentStepVal
							+ "',check_code_state='" + auditState
