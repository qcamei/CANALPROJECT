...
public class WriteCanalCloseContentFGBMAction extends ActionSupport {
	// 分管部门审核函数
		...
		try {
			...
			if (resultStr.equals("success")) {
				...
				if ("通过".equals(auditState)) {
					...
					// 添加流程状态表
					sql = "update  qdzc.canal_step_state_close set oper_user2="
							+ "'" + userName + "',dept_id2='" + deptId
							+ "',dept_name2='" + deptName + "',"
							+ " department_audit_time='" + operTime + "', "
					...
					// 分公司审核-->分管部门审核
					MailRemindUtil.mailKCRM(user, canalName);
