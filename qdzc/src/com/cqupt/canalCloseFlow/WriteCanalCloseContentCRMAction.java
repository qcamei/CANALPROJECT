...
public class WriteCanalCloseContentCRMAction extends ActionSupport {
	// 分管部门审核函数
		...
		try {
			...
			if (resultStr.equals("success")) {
				...
				if ("通过".equals(auditState)) {
					...
					// 添加流程状态表
					sql = "update  qdzc.canal_step_state_close set oper_user3="
							+ "'" + userName + "',dept_id3='" + deptId
							+ "',dept_name3='" + deptName + "',"
							+ " crm_time='" + operTime + "', " + "crm_name='"
							+ currentStepVal + "',crm_state='" + auditState
