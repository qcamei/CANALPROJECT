...
public class WriteCanalCloseContentFGSAction extends ActionSupport {
	// 分公司审核函数
		...
		try {
			...
			if (resultStr.equals("success")) {
				...
				if ("通过".equals(auditState)) {
					...
					// 添加流程状态表
					sql = "update  qdzc.canal_step_state_close set oper_user1="
							+ "'" + userName + "',dept_id1='" + deptId
							+ "',dept_name1='" + deptName + "',"
							+ " branch_audit_time='" + operTime + "', "
