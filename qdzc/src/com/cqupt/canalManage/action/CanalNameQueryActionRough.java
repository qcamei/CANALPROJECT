...
public class CanalNameQueryActionRough extends ActionSupport {
	...
	public String getList(String cityId) {
		...
		try {
			...
			sql = "select t.canal_name label,t.canal_name value,t.agent_name name from qdzc.canal_infomation t ";
