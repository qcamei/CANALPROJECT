...
public class UserQueryActionRough extends ActionSupport {
	...
	public String getList(String cityId) {
		...
		try {
			...
			sql = "select w.user_name label,w.user_name value,w.user_id id from qdzc.sys_dept t ,qdzc.sys_user w where t.dept_id = w.dept_id"
					+ " and group_id = 7 and city_id='" + cityId + "'";
