...
public class Popedom implements Serializable {
	...
	public String toString() {
		return "Popedom [elementId=" + elementId + ", pElementId=" + pElementId
				+ ", elementName=" + elementName + ", elementTitle="
				+ elementTitle + ", elementUrl=" + elementUrl
				+ ", elementGrade=" + elementGrade + ", elementOrder="
				+ elementOrder + ", elementDesc=" + elementDesc
