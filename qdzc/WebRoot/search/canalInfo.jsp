...
<title>渠道信息列表</title>
	...
	<script>
	 ...
	 var manager=null;     
	        $(function() {        
	        	<pageADMOperAuth.tld:pageADMOperAuth menuId="'051307'"></pageADMOperAuth.tld:pageADMOperAuth>       	
	            var v = $("form").validate({
	                //调试状态，不会提交数据的
	                debug: true,
	        ...
	        grid = manager = $("#maingrid4").ligerGrid({
	                columns: [
	                      ...
	                      //	{ display: '当前状态', name: 'currentStepVal', width: 50, minWidth: 50 },
	    					...
	    					{ display: '申请时间', name: 'checkTime', width: 80, minWidth: 60 },
	    					{ display: '申请人部门', name: 'deptName', width: 60, minWidth: 60 }
	    		                ...
	    		                url: 'canalInfoXiuGaiQueryAction',allowAdjustColWidth:true,
...
function f_modifyCanal1(){
	...
	var m = $.ligerDialog.open({ 
	  ...
	  height: 400, 
	  width: 700, 
	  url: 'canalManage/canalInfoXiugai_1.jsp?inId='+row.inId, 
	   showMax: true, 
	   isResize: true
  }); 
  m.max();
