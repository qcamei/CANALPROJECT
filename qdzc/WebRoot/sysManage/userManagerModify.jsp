...
function ajaxUpdate() {
	...
	var myUrl = 'userManagerModifyUserAction';
			...
			<table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
				<tr>
					...
					<td align="left" class="l-table-edit-td">
						<input name="txtUserId" type="hidden" id="txtUserId" value = "${request.txtUserId}"/>
						<input name="oldName" type="hidden" id="oldName" value = "${request.txtName}"/>
						...
						<input name="txtName" type="text" id="txtName" ltype="text"
							...
							onblur="removeAlamTxt('txtName')" value = "${request.txtName}"/>
					</td>
				...
				<tr>
					...
					<td align="left" class="l-table-edit-td">
						...
						<input  type="hidden" name="deptId" id="deptId"  value = "${request.deptId}"/>
                		
                		<input name="deptName" type="text" id="deptName" ltype="text" value = "${request.deptName}" />
					</td>
				...
				<tr>
					...
					<td align="left" class="l-table-edit-td">
						<input type="text" id="txtUserGroup" name="txtUserGroup"
							...
							onblur="removeAlamTxt('txtUserGroup')" value = "${request.txtUserGroup}"/>
					</td>
				</tr>
				<tr>
					<td align="right" class="l-table-edit-td">
					...
					<td align="left" class="l-table-edit-td">
						<input name="txtPhone" type="text" id="txtPhone" ltype="text"
							...
							onblur="removeAlamTxt('txtPhone')" value = "${request.txtPhone}"/>
					</td>
