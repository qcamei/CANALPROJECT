...
var manager = null; 
		...
		$("#remark").ligerComboBox({
			url :'selectDataSelectItemAction',
			isMultiSelect: false,
			onSelected: function (result){
                	$.ajax({
				      	type : "get",
				      	url : "selectPreSelectItemQueryAction?name="+result,
				      	dataType: "text",
				      	async : false,
				      	success : function(data){
				      		var name1 = eval('('+data+')');
				    	  	$("#select").val(name1[0].selectName);
				     	 } 
		    		});
             }
		});   
	...
	function addFile(){
		...
		tdNode_File.innerHTML = "<tr ><td align='right' ><font color='#ff0000'>*</font>下拉列表内容'"+count+"'+:</td><td align='left' ><input type='text' id='selectItem' name='selectItem'  validate='{required:true}'   /></td></tr> ";
		tdNode_del.innerHTML = "<td width='150px'   align='right' ><img src='../images/minus.png' alt='删除选项' onclick='delFile(this)' /></td>";
...
<body style="padding:10px">
	...
	<table width="100%" id="fileid" style="margin-top:10px;">  
	
        	<tr >
                <td width="150px" align="right"><font color="#ff0000">*</font>下拉列表名称:</td>
                  <td class="l-table-edit-td"  width="150px" align="left"><input type="text"  ltype="text"  id="remark" name="remark"  validate="{required:true}"  /></td>
            </tr>  
         
           <tr>
                <td align="right" ><font color="#ff0000">*</font>下拉列表内容:</td>
                <td class="l-table-edit-td"  width="150px" align="left">
                <input type="text" id="selectItem" name="selectItem"  validate="{required:true}"   />
                </td>
           </tr> 
    <tr>
                <td align="right" ><font color="#ff0000">*</font>下拉列表英文名:</td>
                
                <td align="left" class="l-table-edit-td">
                	<input type="text" id="select" name="select" readonly="readonly" validate="{required:true}"  />
                <td align="left" >(<font color="#ff0000">*</font>自动生成，不能修改！)</td>
                
           </tr> 
   
			<!--  <tr>
    			<td align="right" ><a href="javascript:void(0)" align="center" onclick="addFile()"><img src='../images/plus.png' alt='添加选项' /></a></td>
    			<td align="left" ></td>
    		</tr> -->
	</table>
	
		 <center>
                 <input type="submit" class="l-button-submit" value="提交" />  
	      </center>
	</form>
 ...
 function ajaxUpdate(){       
	        $.blockUI({message:'<h5><img src="../images/loading.gif" /> 系统正在提交中……</h5>' }); 
			 ...
			 params = encodeURIComponent(encodeURIComponent(params)).replace(/%253D/g,'=').replace(/%2526/g,'&');
		      ...
		      $.ajax({   
		              url :'selectDataAddAction',  //后台处理程序   
		              type:'post',    //数据发送方式   
