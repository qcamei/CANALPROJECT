	...
	function ajaxUpdate(){ 
	    ...
	    $.blockUI({message:'<h5><img src="images/loading.gif" /> 系统正在提交中……</h5>' }); 
	     var params=$('#form1').serialize().replace(/\+/g, ' '); //这里直接就序列化了表单里面的值；很方便  
	      ...
	      $.ajax({   
	              url :'selectDataUpdateAction',  //后台处理程序   
	              type:'post',    //数据发送方式   
...
<body style="padding:10px">
	...
	<table width="100%" style="margin-top:10px;">  
			<tr >
                <td align="right" class="l-table-edit-td"><font color="#ff0000">*</font>下拉列表名称:</td>
                <td align="left" class="l-table-edit-td">
                	<input type="text" id="remark" name="remark" value="${remark }" readonly="readonly" validate="{required:true}"  />
                	<input type="hidden" id="selectId" value="${selectId }" name="selectId" />
                </td>
           </tr>  
           <tr >
                <td align="right" class="l-table-edit-td"><font color="#ff0000">*</font>下拉列表内容:</td>
                <td align="left" class="l-table-edit-td">
                	<input type="text" id="selectItem" name="selectItem" value="${selectItem }" validate="{required:true}"  />
