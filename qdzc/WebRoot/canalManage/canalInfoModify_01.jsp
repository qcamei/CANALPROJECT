...
$(function(){
	...
	$("#terminalType").ligerComboBox({
		url :'selectItemQueryAction?type=terminal_type', 
		isMultiSelect: false,
...
//	$("#printNumber").ligerComboBox({url :'selectItemQueryAction?type=print_number', isMultiSelect: false});
	$("#isNoPaper").ligerComboBox({url :'selectItemQueryAction?type=is_true', isMultiSelect: false});
	$("#kernal").ligerComboBox({url :'selectItemQueryAction?type=kernal', isMultiSelect: false});
	$("#1").hide();
	$("#2").hide();
	$("#3").hide();
	$("#4").hide();
	$("#5").hide();
	$("#checkUser").ligerComboBox({url :'selectItemQueryAction?type=check_user', isMultiSelect: false}); 
	$("#form1").ligerForm(); 
...
function ajaxUpdate() {
	...
	$.ajax({
		url : 'canalModifyAction01', //后台处理程序   
		type : 'post', //数据发送方式   
...
<h2>渠道信息</h2>
	...
	<li>
			...
			<input name="canalForm" type="text" id="canalForm"  onchange="getCanalType()"  value="${request.canalForm}" />
		</li>
		<li>
			<font>*</font><span>管理属性：</span>
			<input name="canalType"  type="text" id="canalType" value="${request.canalType}"  onchange="getCanalProperty()"  onfocus="alamTxt('canalType','请先选择渠道形态！')" onblur="removeAlamTxt('canalType')" />
	...
	<div class="dash"></div>
		...
		<li class="add">
			...
			<input type="text"   ltype="text" id="agentShortName" name="agentShortName"   value="${request.agentShortName }"  onfocus="alamTxt('agentShortName','厅店名称简称')" onblur="removeAlamTxt('agentShortName')" />
	  ...
	  <h2>渠道信息</h2> 
		...
		<li>
			...
			<input name="canalName" type="text" id="canalName" ltype="text"  value="${request.canalName }"  onfocus="alamTxt('canalName','渠道名称')" onblur="removeAlamTxt('canalName')" />
		</li>
		<li>
			<font>*</font><span>区域名称：</span>
			<input name="areaName" type="text" id="areaName"   value="${request.areaName }" />

		</li>
		
		<li>
			<font>*</font><span>区域特征：</span>
			<input name="regionCharacter" type="text" id="regionCharacter"  value="${request.regionCharacter }"/>

		</li>
		<li>
			<font>*</font><span>渠道地址：</span>
			<input name="canalAddress" type="text" id="canalAddress"   value="${request.canalAddress }"   onfocus="alamTxt('canalAddress','厅店详细地址')" onblur="removeAlamTxt('canalAddress')"  />
		</li>
		<li>
			<font>*</font><span>渠道归属部门：</span>
			<input name="canalDept" type="text" id="canalDept"  value="${request.canalDept }"  onfocus="alamTxt('canalDept','渠道所属部门')" onblur="removeAlamTxt('canalDept')"/>

		</li>
		<li>
			<font>*</font><span>对口支撑人(渠道客户经理)：</span>
			<input name="canalUserName"  type="text" id="canalUserName"  value="${request.canalUserName }"  />
		</li>
		<li>
			<font>*</font><span>对口支撑人电话：</span>
			<input name="canalUserPhone" type="text" id="canalUserPhone"   value="${request.canalUserPhone }"  onblur="checklegal('canalUserPhone')"/>
		...
		<li>
			...
			<input name="urbanIdetity" type="text" id="urbanIdetity"  value="${request.urbanIdetity }"  />
		</li>
		<li>
		...
		<li>
			...
			<input name="privilege" type="text" id="privilege"  readonly  value="普通营业员权限，不开销帐权限"  />
		</li>
		<li>
	...
	<h2>渠道营业员信息：</h2>
		...
		<li>
			...
			<input type="text"   ltype="text"  id="userName" name="userName" value="${request.userName }"  onblur="getPinyin()"    />
		</li>
		<li>
			<span>姓名拼音：</span>
		...
		<li>
			...
			<input type="text"  ltype="text"  id="hm"  name="hm"  value="${request.hm }" />
		</li>
		<li>
			<font class="nima">&nbsp;</font><span>开户银行：</span>
			<input type="text"  ltype="text"  id="khyh"  name="khyh"   value="${request.khyh }"  />
		</li>
		<li>
			<font class="nima">&nbsp;</font><span>卡号：</span>
			<input type="text"  ltype="text"  id="kh"  name="kh"  value="${request.kh }"  />
		</li>
		<li>
			<font class="nima">&nbsp;</font><span>身份证号：</span>
			<input type="text"  ltype="text"  id="sfzh"  name="sfzh"   value="${request.sfzh }"  />
		</li>
	 
	 <h2>CRM工号及代理商门户网站工号：</h2>
		 <div class="dash"></div>		 
		 	<li>
			<span>CRM工号：</span>
			<input type="text"  ltype="text"  id="crmNumber" name="crmNumber" value="${request.crmNumber}" />
		</li>
		 	<li>
			<span>代理商门户网站工号：</span>
			<input type="text"  ltype="text"  id="agentJobNumber" name="agentJobNumber" value="${request.agentJobNumber}" />
		</li>
	<h2>设备基础配置</h2>
		 <div class="dash"></div>
		<li>
			<span>受理设备类型：</span>
			<input type="text"  ltype="text"  id="terminalType" name="terminalType" value="${request.terminalType}" />
		</li>
		<li>
			<span>终端一键式账号：</span>
			<input type="text"  ltype="text"  id="dx360Number" name="dx360Number" value="${request.dx360Number}"  />
		</li>
		<li id="0">
			<span>终端机型号：</span>
			<input type="text"   ltype="text" id="terminalNumber" name="terminalNumber" value="${request.terminalNumber}" />
		</li>
		<li id="1">
			<span>CPU：</span>
			<input type="text"  ltype="text"  id="cpu" name="cpu" value="${request.cpu}"  />
		</li>
		<li  id="2">
			<span>核数：</span>
			<input type="text"  ltype="text"  id="kernal" name="kernal"  value="${request.kernal}" />
		</li>
		<li   id="3">
			<span>主频：</span>
			<input type="text"  ltype="text"  id="frequency" name="frequency" value="${request.frequency}"  />
		</li>
		<li id="4">
			<span>内存：</span>
			<input type="text"  ltype="text"  id="memory" name="memory" value="${request.memory}"  />
		</li>
		<li  id="5">
			<span>硬盘：</span>
			<input type="text"   ltype="text" id="disk" name="disk" value="${request.disk}" />
		</li>
		<li>
			<span>打印机型号：</span>
			<input type="text"  ltype="text"  id="printNumber" name="printNumber" value="${request.printNumber}"  />
		</li>
		<li>
			<span>是否使用无纸化：</span>
			<input type="text"  ltype="text"  id="isNoPaper" name="isNoPaper"  value="${request.isNoPaper}" />
		</li>
	 <h2>专线受理</h2>
		<div class="dash"></div>
		<li>
			<font class="nima">&nbsp;</font><span>专网账号：</span>
			<input type="text"  ltype="text"  id="broadbandAccount"  name="broadbandAccount"   value="${request.broadbandAccount }"  />
		</li>
		<li>
			<font class="nima">&nbsp;</font><span>专网密码：</span>
			<input type="text"  ltype="text"  id="broadbandPassword"  name="broadbandPassword"  value="${request.broadbandPassword }"  />
		</li>
		<li>
			<font class="nima">&nbsp;</font><span>外网账号：</span>
			<input type="text"  ltype="text"  id="wwwAccount"  name="wwwAccount"   value="${request.wwwAccount }"  />
		</li>
		<li>
			<font class="nima">&nbsp;</font><span>外网优惠：</span>
			<input type="text"  ltype="text"  id="wwwPrivilegeInfo"  name="wwwPrivilegeInfo"   value="${request.wwwPrivilegeInfo }"  />
		</li>
	 <h2>资金稽核编码</h2>
		<div class="dash"></div>
		<li>
			<font class="nima">&nbsp;</font><span>稽核厅编码：</span>
			<input type="text"  ltype="text"  id="checkNumber"  name="checkNumber"   value="${request.checkNumber }"  />
		</li>
		<li>
			<font class="nima">&nbsp;</font><span>稽核厅名称：</span>
			<input type="text"  ltype="text"  id="checkName"  name="checkName"  value="${request.checkName }"  />
		</li>
		<li>
			<font class="nima">&nbsp;</font><span>资金稽核系统账号：</span>
			<input type="text"  ltype="text"  id="moneyLogin"  name="moneyLogin"   value="${request.moneyLogin }"  />
		</li>
	<h2>配置稽核人员</h2>
		<div class="dash"></div>
		<li>
			<font class="nima">&nbsp;</font><span>稽核人员：</span>
			<input type="text"  ltype="text"  id="checkUser"  name="checkUser"   value="${request.checkUser }"  />
		</li>		
	</ul>
	<center>
