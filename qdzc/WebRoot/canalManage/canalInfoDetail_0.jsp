...
<form action="" method="post" name = "form" id = "form1" >
	<ul>
		...
		<li>
			<span>上级合作伙伴编码：</span>
			<input type="text"  ltype="text"  id="parentId" name="parentId"  value="${request.parentId}"  />
		</li>
		<li>
			<span>上级合作伙伴名称：</span>
			<input type="text"  ltype="text"  id="parentName" name="parentName" value="${request.parentName}"   />
		</li>
		<li>
			<span>公司办公地址：</span>
			<input type="text"   ltype="text" id="companyAddress" name="companyAddress" value="${request.companyAddress}"  />
		</li>
		<li>
			<span>负责人联系地址：</span>
			<input type="text"  ltype="text"  id="ondutyPersonAddress" name="ondutyPersonAddress"   value="${request.ondutyPersonAddress}"   />
		</li>
		<li>
			<span>负责人QQ：</span>
			<input type="text"  ltype="text"  id="ondutyPersonQqnum" name="ondutyPersonQqnum" value="${request.ondutyPersonQqnum}"    />
		</li>
		<li>
			<span>邮政编码：</span>
			<input type="text"   ltype="text" id="postCode" name="postCode" value="${request.postCode}"  />
		</li>
		<li>
			<span>传真：</span>
			<input type="text"  ltype="text"  id="agentFax" name="agentFax" value="${request.agentFax}"  />
		</li>
		<li>
			<span>电子邮箱：</span>
			<input type="text"   ltype="text" id="agentEmail" name="agentEmail" value="${request.agentEmail}"  />
		</li>
		<li>
			<span>付款方式：</span>
		...
		<li>
			<span>银行账户名称：</span>
			<input type="text"   ltype="text" id="bankAccountName" name="bankAccountName"  value="${request.bankAccountName}"  />
		</li>
		<li>
			<span>委托收款方开户银行：</span>
			<input type="text"  ltype="text"  id="weituoStartBank" name="weituoStartBank"  value="${request.weituoStartBank}"  />
		</li>
		<li>
			<span>委托收款方帐号：</span>
			<input type="text"  ltype="text"  id="weituoBankAccount" name="weituoBankAccount"  value="${request.weituoBankAccount}"  />
		</li>
		<li>
			<span>委托收款方名称：</span>
			<input type="text"   ltype="text" id="weituoBankName" name="weituoBankName"  value="${request.weituoBankName}"   />
		</li>
		<li>
			<span>支付对象：</span>
			<input type="text"  ltype="text"  id="payObject" name="payObject"  value="${request.payObject}"  />
		</li>
		<li>
			<span>注册资本：</span>
			<input type="text"   ltype="text" id="registerMoney" name="registerMoney"  value="${request.registerMoney}" />
		</li>
		<li>
			<span>工商登记时间：</span>
		...
		<li>
			<span>法人营业执照编号：</span>
			<input type="text"  ltype="text"  id="businessLicenseId" name="businessLicenseId" value="${request.businessLicenseId}"  />
		</li>
		<li>
			<span>税务登记证编号：</span>
			<input type="text"  ltype="text"  id="taxRegisteId" name="taxRegisteId" value="${request.taxRegisteId}"  />
		</li>
		<li>
			<span>银行开户许可证编号：</span>
			<input type="text"  ltype="text"  id="bankPermisionId" name="bankPermisionId" value="${request.bankPermisionId}"  />
		</li>
		<li>
			<span>组织机构代码证编号：</span>
			<input type="text"   ltype="text" id="organizationCodeId" name="organizationCodeId" value="${request.organizationCodeId}"   />
		</li>
		...
		<li>
			<span>月租金额：</span>
			<input name="rentMoney" type="text" id="rentMoney"  value="${request.rentMoney}" />
		</li>
		<li>
			<span>合同期补贴政策：</span>
		...
		<li>
			<span>所属渠道客户经理：</span>
			<input name="canalManager"type="text" id="canalManager"  value="${request.canalManager}"  />
            <input name="canalManagerId" type="hidden" id="canalManagerId" value="${request.canalManagerId}" />
		</li> -->
		<li>
			<span>归属上级渠道名称：</span>
			<input name="canalParentName" type="text" id="canalParentName" value="${request.canalParentName}"  />
		</li>
		<li>
			<span>归属上级渠道编码：</span>
			<input name="canalParentId" type="text" id="canalParentId" value="${request.canalParentId}"   />
		</li>
		<li>
			<span>房产权所有人姓名：</span>
		...
		<li>
			<span>房产权所有人电话：</span>
			<input name="houseOwnerPhone" type="text" id="houseOwnerPhone"  value="${request.houseOwnerPhone}" />
		</li>
		<li>
			<span>是否发卡网点：</span>
			<input name="distributeCard" type="text" id="distributeCard"   value="${request.distributeCard}"  />
		</li>
		<li>
			<span>开户人身份证号：</span>
			<input name="inPersonIdCard" type="text" id="inPersonIdCard" value="${request.inPersonIdCard}"  />
		</li>
		<li>
			<span>营收资金银行账号：</span>
		...
		<li>
			<span>身份证号：</span>
			<input type="text"  ltype="text"  id="userIdCard" name="userIdCard" value="${request.userIdCard}"   />
		</li>
		<li>
			<span>工号权限：</span>
		...
		<li>
			<span>邮箱：</span>
			<input type="text"  ltype="text"  id="userEmail" name="userEmail"  value="${request.userEmail}"  />
		</li>
		<li>
			<span>计费角色：</span>
		...
		<li>
			<span>联系电话：</span>
			<input type="text"   ltype="text" id="userPhone" name="userPhone" value="${request.userPhone}"   />
		</li>
		<li>
			<span>文化程度：</span>
