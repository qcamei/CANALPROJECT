...
<h2>渠道信息</h2>
	...
	<li>
			...
			<input name="canalForm" type="text" id="canalForm" validate="{required:true}" onchange="getCanalType()"  />
		</li>
		<li>
			<font>*</font><span>管理属性：</span>
			<input name="canalType"  type="text" id="canalType"   validate="{required:true}" onchange="getCanalProperty()"  onfocus="alamTxt('canalType','请先选择城乡！')" onblur="removeAlamTxt('canalType')" />

		</li>
		<li>
			<font>*</font><span>分类名称：</span>
			<input name="canalProperty" type="text" id="canalProperty" validate="{required:true}" onchange="getCanalXingzhi()" onfocus="alamTxt('canalProperty','请先选择管理属性！')" onblur="removeAlamTxt('canalProperty')" />
		</li>
		<!--  <li>
			<font>*</font><span>渠道性质：</span>
			<input name="canalXingzhi" ltype="text" type="text" id="canalXingzhi"  validate="{required:true}" />
		</li>
		-->
<h2>代理商信息</h2>
	<div class="dash"></div>
	 <li>
		...
		<li class="add">
			<font>*</font><span>分公司：</span>
			 <input type="text" ltype="text" id="branchCompany" name="branchCompany" value="现业" onfocus="alamTxt('branchCompany','厅店所属分公司')" onblur="removeAlamTxt('branchCompany')" />
		...
		<li class="add">
			...
			<input type="text"   ltype="text" id="legalIdCard" name="legalIdCard"  onfocus="alamTxt('legalIdCard','法人代表身份证号码')" onblur="checklegal('legalIdCard')" />
	...
	<div class="dash"></div>
		...
		<li>
			...
			<input name="areaName" type="text" id="areaName"  validate="{required:true}" value="现业" />
	...
	<!-- 	<li >
		...
		<li class="add">
			...
			<input type="text"  ltype="text"  id="bankAccountId" name="bankAccountId"    onfocus="alamTxt('bankAccountId','银行卡号')" onblur="removeAlamTxt('bankAccountId')"  />
		</li>
		<li>
	...
	<div class="dash"></div>
		...
		<li>
			...
			<input type="text"  ltype="text"  id="sfzh"  name="sfzh"  validate="{required:true}" onblur="checklegal('sfzh')" />
		</li>
	</ul>
