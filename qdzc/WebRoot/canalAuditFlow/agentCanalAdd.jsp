...
<link href="../com_css/LigerUILib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
           $(function() {
        	 ...
        	 $("#auditState").ligerComboBox({url :'selectItemQueryAction?type=audit_state', isMultiSelect: false});	var v = $("form").validate({
                 debug: true,
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="500px">
        	<tr>
                ...
                <input name="inId" type="hidden" id="inId" />
                	<input name="canalId" type="text" id="canalId"   ltype="text" validate="{required:true}" />
                </td>
                <td width="100px"></td>
            </tr>
        	<tr>
            	...
            	<tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>代理商编码:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="agentId" type="text" id="agentId"  ltype="text" validate="{required:true}" />
                </td>
                <td></td>
            </tr>
        	<tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>代理商名称:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="agentName" type="text" id="agentName" ltype="text"  validate="{required:true}"/>
                </td>
                <td></td>
            </tr>
            <tr>
            ...
            <!--  <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>厅店性质:</td>
                <td align="left" class="l-table-edit-td"> 
                <input  ltype="text"  name="canalGenre" id="canalGenre" type="text"  validate="{required:true}"/>
                </td>
                <td></td>
            </tr>
            
              <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>渠道类别:</td>
                <td align="left" class="l-table-edit-td"> 
                
                <input   name="canalGenre" id="canalGenre" type="hidden"  value="无"/>
                <input  ltype="text"  name="canalClasses" id="canalClasses" type="text" validate="{required:true}" />
                </td>
                <td></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>归属渠道客户经理:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="belongManager" type="text" id="belongManager" ltype="text" validate="{required:true}" />
                </td>
                <td align="left">(模糊查询)</td>
            </tr>
             <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>归属机构:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="belongInstitutionId" type="text" id="belongInstitutionId" ltype="text"   />
                </td>
                <td></td>
            </tr>
             <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>归属支分局:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="belongBranch" type="text" id="belongBranch" ltype="text"  validate="{required:true}" />
                </td>
                <td align="left"></td>
            </tr> -->
            <tr>
...
<script type="text/javascript">
  function ajaxUpdate(){//提交表单内容
			 ...
			 params = encodeURIComponent(encodeURIComponent(params)).replace(/%253D/g,'=').replace(/%2526/g,'&');
		      ...
		      $.ajax({   //把表单内容插入数据库
		              url :'agentCanalAddAction',  //后台处理程序   
		              type:'post',    //数据发送方式   
