...
<link href="../com_css/LigerUILib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
           $(function() {
       		...
       		$("#inId").val("${request.inId}");
       		$("#canalName").val("${request.canalName}");
       		$("#canalId").val("${request.canalId}");
       		
       		$('#openTime').ligerDateEditor({
       			labelWidth : 100,
       			labelAlign : 'right',
       			format : "yyyy-MM-dd"
       		});
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
        	<tr>
             ...
             <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="broadbandAccount" type="text" id="broadbandAccount" ltype="text" validate="{required:true}" value="${request.broadbandAccount}"/>
             ...
             <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="broadbandPassword" type="text" id="broadbandPassword" ltype="text" validate="{required:true}" value="${request.broadbandPassword}"/>
                </td>                
            </tr>
            
            <tr>
                <td align="right" class="l-table-edit-td"><font color="#ff0000">*</font>开通专线时间:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="openTime" type="text" id="openTime" ltype="text" validate="{required:true}" />
                	
                </td>
            </tr>
            
            <!-- <tr>
                <td align="right" class="l-table-edit-td"><font color="#ff0000">*</font>连接服务器IP:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="serverIp" type="text" id="serverIp" ltype="text" onblur="check()" validate="{required:true}" />
                </td>
            </tr> -->
...
//serverIp,检测规则　
	/*function check(){
		//验证电话号码手机号码，包含至今所有号段   
		var ab = /^(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9]{1,2})(\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9]{1,2})){3}$/;
		var serverIp = $('#serverIp').val();
		if(serverIp != null && serverIp!=""){
			if (ab.test(serverIp) == false) {
				alert("请正确填写IP地址,例如127.0.0.0！");
				return false;
			}
		}
}*/
  ...
  function ajaxUpdate(){//提交表单内容
			 ...
			 params = encodeURIComponent(encodeURIComponent(params)).replace(/%253D/g,'=').replace(/%2526/g,'&');
		      ...
		      $.ajax({   //把表单内容插入数据库
		              url :'configLineAddAction',  //后台处理程序   
		              type:'post',    //数据发送方式   
