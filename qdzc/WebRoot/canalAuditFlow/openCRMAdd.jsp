...
<link href="../com_css/LigerUILib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
           $(function() {
        	   ...
        	   $("#privilege").ligerComboBox({url :'selectItemQueryAction?type=privilege', isMultiSelect: true});
       	 ...
       	 $("#employeeName").ligerComboBox({url :'employeeNameQueryAction?inId='+inId,  isMultiSelect: false	});	  
       	 $("form").ligerForm();
...
<body style="padding:10px">
    ...
    <form name="form1" method="post" action="" id="form1">
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="100%">
            ...
            <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>营业员姓名:</td>
                <td align="left" class="l-table-edit-td"> 
                <input  ltype="text"  name="employeeName" id="employeeName" type="text" ltype="text" validate="{required:true}" />
                </td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>CRM工号:</td>
                <td align="left" class="l-table-edit-td"> 
                <input  ltype="text"  name="crmNumber" id="crmNumber" type="text" ltype="text" validate="{required:true}" />
                </td>
            </tr>
             <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>绑定手机号码:</td>
                <td align="left" class="l-table-edit-td"> 
                <input  ltype="text"  name="telephone" id="telephone" type="text" ltype="text" onfocus="openCRM()" onchange="checklegal()"     validate="{required:true}" />
                </td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>工号权限:</td>
                <td align="left" class="l-table-edit-td">
                	<input name="privilege" type="text" id="privilege" ltype="text" validate="{required:true}" />
                </td>
            </tr>
            <tr>
...
<script type="text/javascript">
  function ajaxUpdate(){//提交表单内容
   ...
   //验证CRM工号是否已填
   function openCRM(){
	   var telephone = $("#crmNumber").val();
	   if(telephone == ""){
		   $.ligerDialog.error("请先填写CRM工号！!");
	    	$("#telephone").focus();
	   }
   }
   	function checklegal(){
