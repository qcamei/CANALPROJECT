...
<%
     ...
     response.setHeader( "Content-disposition","inline; filename="+ (new String(("工单处理详情").getBytes("GB2312"),"ISO8859_1")) + ".doc");
 %>
...
String sql = "select a.in_id,a.canal_name,a.agent_name,a.canal_manager,a.canal_dept from qdzc.canal_infomation  a where  a.canal_id = '"+canalId+"'";
System.out.println("查询工单的处理详情:"+sql);
...
<table border=0 cellSpacing=0 cellPadding=0 width="100%"  align=center>
 	<tr>
	  <td vAlign=center align=center>
	  	<FONT size="4" face=楷体_GB2312>  <strong>工单处理详情</strong></FONT>
	  </td>
 	</tr>
  <tr>
    <td>
...
<table cellspacing="0" cellpadding="0" width="100%" class="listDetail">
          ...
          <tr>            
            <td width="11%"><div align="center">工单号</div></td>
