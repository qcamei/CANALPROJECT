 ...
 <link href="./com_css/LigerUILib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" />
  ...
  <script src="./com_css/LigerUILib/ligerUI/js/plugins/ligerTip.js" type="text/javascript"></script>
   ...
   <link href="./com_css/jqueryUI/themes/base/jquery.ui.all.css" rel="stylesheet">
	...
	<script src="./canalModifyFlow/canalInfoAdd.js"></script>
...
function ajaxUpdate() {
	var a="${request.guaranteeReceiptScanUrl}";
	if(a == ""){
...
function submit_Result(result) { //回传函数实体，参数为XMLhttpRequest.responseText   
	...
	if(result == "success"){
		...
		$.ligerDialog.error('修改出错！','提示',function(){ });  
	}else{
...
<h2>渠道信息</h2>
	...
	<li>
		<font>*</font><span>城乡：</span>
			...
			<input type="hidden" id="agentId" name="agentId" value="${request.agentId }"/>
	...
	<div class="dash"></div>
		...
		<li class="add">
			...
			<input type="text"   ltype="text" id="startBank" name="startBank"  validate="{required:true}" value="${request.startBank }" onfocus="alamTxt('startBank','邮政银行')" onblur="removeAlamTxt('startBank')"  />
			<input name="startBankOld"  type="hidden"  value="${request.startBank}" />
		</li>
		<li class="add">
			<font >*</font><span>银行账号：</span>
			<input type="text"  ltype="text"  id="bankAccountId" name="bankAccountId"   validate="{required:true}" value="${request.bankAccountId }" onfocus="alamTxt('bankAccountId','银行卡号')" onblur="removeAlamTxt('bankAccountId')"  />
		...
		<li>
			...
			<input name="expireType" type="text" id="expireType" validate="{required:true}" value="${request.expireType }" />
		...
		<li>
			<font>*</font><span>是否开CRM工号：</span>
			<input name="isOpenCrm" type="text" id="isOpenCrm" validate="{required:true}"  value="是" />
		</li>
		<li>
			<font>*</font><span>开CRM工号个数：</span>
			<input name="number" type="text" id="number"  validate="{required:true}" ltype='spinner' ligerui="{type:'int'}"  value="1"/>
		</li>
		<li>
		...
		<li>
			...
			<input name="guaranteeAmount" type="text" id="guaranteeAmount"  ltype='spinner' ligerui="{type:'float'}" readonly="readonly"   value="${request.guaranteeAmount }"/>
		...
		<li>
			<font class="alterMoney">&nbsp;</font><span>变更金额：</span>
			<input name="moneyAmount" type="text" id="moneyAmount"  ltype='spinner' ligerui="{type:'float'}" validate="{required:true}"  />
		</li>
		<li>
			<font class="alterMoney">&nbsp;</font><span>变更备注：</span>
		...
		<li>
            ...
            <input name="guaranteeReceiptScanUrl" type="hidden" id="guaranteeReceiptScanUrl" value="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
