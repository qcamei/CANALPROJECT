...
<title>第四五步 代理商系统渠道信息确认(代理商渠道信息确认变更)</title>
<link href="../com_css/LigerUILib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
           $(function() {
        	...
        	//   $("#canalClasses").ligerComboBox({url :'selectItemQueryAction?type=canal_classes', isMultiSelect: false});
        	//   $("#canalGenre").ligerComboBox({url :'selectItemQueryAction?type=canal_genre', isMultiSelect: false});
    ...
    <form name="form1" method="post" action="" id="form1">
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" width="500px">
        	...
        	<tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="agentId" type="text" id="agentId"  ltype="text" readonly="readonly" validate="{required:true}" />
                </td>
                <td></td>
            </tr>
        	<tr>
        ...
        <!--    <tr>
                <td align="right" class="l-table-edit-td"><font color="red">*</font>厅店类型:</td>
                <td align="left" class="l-table-edit-td"> 
            ...
            <tr>
             ...
             <tr>
                <td align="right" class="l-table-edit-td">归属上级渠道ID:</td>
                <td align="left" class="l-table-edit-td">
