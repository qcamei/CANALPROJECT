...
<title>财务审核环节</title>
    ...
    var manager=null;
    $(function() {        
    	<pageADMOperAuth.tld:pageADMOperAuth menuId="'060601','060602','060603','060604','060605'"></pageADMOperAuth.tld:pageADMOperAuth>       	
        var v = $("form").validate({
            //调试状态，不会提交数据的
            debug: true,
          ...
          function f_excelOut() {
	            ...
	            var nextStepVal = encodeURI(encodeURI($("#nextStepVal").val()));	                	
	           	$.ligerDialog.confirm('确认要导出渠道信息吗？', function (yes){	    	            
	           	  if(yes)
	           		  window.open('"canalAlterFinanceInfoDownExcel"?txtBeginDate='+txtBeginDate+'&txtEndDate='+txtEndDate+'&inId='+inId+'&areaName='+areaName+'&canalName='+canalName+'&canalId='+canalId+'&nextStepVal='+nextStepVal);
	           	   			window.close();
	    	            });
		...
		<form name="form1" method="post" action="" id="form1">
			...
			<table cellpadding="0" cellspacing="0" class="l-table-edit">
				...
				<tr>
					...
					<td><input	name="nextStepVal"    id="nextStepVal"  type="text" value="账务审核"/></td>
...
function f_modify(){
	...
	var  m=$.ligerDialog.open({ 
	  ...
	  height: 500, 
	  width: 700, 
	  url: 'canalModifyFlow/detailModify.jsp?inId='+inId+'&canalName='+canalName+'&canalId='+canalId+'&agentId='+agentId+'&agentName='+agentName+'&process=finance', 
	   showMax: true, 
	   isResize: true
  }); 
	m.max();
