...
String canalName=java.net.URLDecoder.decode(request.getParameter("canalName"), "UTF-8");
...
<body>
	 <div id="navtab2" style="overflow: hidden;border: 1px solid #D3D3d3;" class="liger-tab">
		<div tabid="home"  title="添加处理意见" lselected="true">
			<iframe src="canalCloseReasonK.jsp?inId=<%=inId %>&closeId=${param.closeId}&canalName=<%=canalName %>&money=${param.money}" ></iframe>			
		</div>
		<div  title="工单处理详情" >
