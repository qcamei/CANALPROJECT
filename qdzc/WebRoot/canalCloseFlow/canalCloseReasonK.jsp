...
<%@ page import="com.cqupt.pub.dao.DataStormSession,java.util.*,java.util.Map,java.text.SimpleDateFormat,com.cqupt.pub.util.DecodeUtils,com.cqupt.pub.util.JsonUtil" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%
DataStormSession session1 = null;
session1 = DataStormSession.getInstance();
String inId=java.net.URLDecoder.decode(request.getParameter("inId"),"UTF-8");
String sql="select guarantee_amount from canal_infomation where in_id='"+inId+"'";
List resultList=session1.findSql(sql);
Map resultMap=(Map)resultList.get(0);
Float guaranteeAmount=(Float)resultMap.get("guaranteeAmount");
%>
<%	
  	   ...
  	   $.metadata.setType("attr", "validate");
           ...
           submitHandler: function ()
           {
 			...
 			$("#auditState").ligerComboBox({
				url :'selectItemQueryAction?type=audit_state',
					isMultiSelect: false
                     });
 ...
 $("form").ligerForm();
		 ...
		 function ajaxUpdate(){//提交表单内容
		         ...
		         var close='<%= request.getParameter("closeId")%>';  
			      $.ajax({   //把表单内容插入数据库
			              url :'writeCanalCloseContentCWSHAction?inId='+ind+'&closeId='+close,  //后台处理程序   
			              type:'post',    //数据发送方式   
...
<td class="l-table-edit-td"  width="120px" >
<input type="text" id="money"  name="money" value="${param.money}" readonly="readonly" /></td>
</tr>
 
<tr> 
<td  align="right" class="l-table-edit-td">保证金金额：</td>
<td class="l-table-edit-td"  width="120px" >
<input type="text" id="guaranteeAmount"  name="guaranteeAmount" value=<%=guaranteeAmount%> readonly="readonly" /></td>
</tr>
 <tr> 
<td  align="right" class="l-table-edit-td">实际退款金额：</td>
<td class="l-table-edit-td"  width="120px" >
<input type="text" id="returnMoney"  name="returnMoney" /></td>
</tr>
  
<tr>
<td  align="right" class="l-table-edit-td">审核状态：</td>
<td class="l-table-edit-td"  width="120px" >
<input type="text" id="auditState" name="auditState"  /></td>
</tr>  
<tr> <td align="right" class="l-table-edit-td"></td></tr>

<tr>
<td  align="right" class="l-table-edit-td">审核意见：</td>
...
<td align="left" class="l-table-edit-td"> 
<input type="submit" value="提交" onclick="ajaxUpdate()" class="l-button l-button-submit" /> </td>
</tr>
